...
df["Revenue(millions)"].fillna(df["Revenue(millions)"].mode()[0], inplace=True)
...
print(actors_num_df.iloc[0:1])
print(f"The most common actor in all movies is {actor_top} with {list(actors_num_max)} movies")
print("\n")
...
print("Correlations with original dataset")
corr_Rating=df["Rank"].corr(df["Rating"]).round(3)
print(f"The correlation with the Rank and Rating is {corr_Rating}")
corr_Votes=df["Rank"].corr(df["Votes"]).round(3)
print(f"The correlation with the Rank and Votes is {corr_Votes}")
corr_Revenue=df["Rank"].corr(df["Revenue(millions)"]).round(3)
print(f"The correlation with the Rank and Revenue is {corr_Revenue}")
corr_Meta=df["Rank"].corr(df["Metascore"]).round(3)
print(f"The correlation with the Rank and Metascore is {corr_Meta}")
corr_Revenue_Rate=df["Revenue(millions)"].corr(df["Rating"]).round(3)
print(f"The correlation with the Revenue and Rating is {corr_Revenue_Rate}")
corr_Revenue_Meta=df["Revenue(millions)"].corr(df["Metascore"]).round(3)
print(f"The correlation with the Revenue and Metascore is {corr_Revenue_Meta}")
corr_Revenue_Year=df["Revenue(millions)"].corr(df["Year"]).round(3)
print(f"The correlation with the Revenue and Year is {corr_Revenue_Year}")
print("\n")
